#!/bin/bash
# fix_training_issues.sh - Fix gradient explosion and improve training

echo "🔧 Fixing training issues (gradient explosion, class imbalance)..."
echo "="*70

# Create improved training script
cat > src/training/train_dp_improved.py << 'EOF'
#!/usr/bin/env python3
"""
...
echo "✅ Created improved training script: train_dp_improved.py"
echo ""
echo "🚀 RUN THE IMPROVED VERSION:"
echo "   python src/training/train_dp_improved.py --epsilon 8.0 --epochs 10"
echo ""
echo "📌 KEY IMPROVEMENTS:"
echo "   1. ✅ Gradient clipping to prevent explosion"
echo "   2. ✅ Lower learning rate (0.0005 instead of 0.001)"
echo "   3. ✅ Class weighting for imbalanced data (18% PII vs 82% non-PII)"
echo "   4. ✅ Early stopping (stops when no improvement for 3 epochs)"
echo "   5. ✅ Better feature engineering (12 features instead of 8)"
echo "   6. ✅ Batch normalization for stability"
echo "   7. ✅ Comprehensive monitoring (gradient norms, precision, recall, F1)"
echo "   8. ✅ Best model saving"
echo ""
echo "📊 EXPECTED RESULTS:"
echo "   • Loss should DECREASE (not explode)"
echo "   • Should find optimal epoch automatically via early stopping"
echo "   • Better metrics for the minority class (PII)"
echo ""
echo "🔍 For your current results: STOP AT EPOCH 1!"
echo "   Your best model is already saved from epoch 1."
